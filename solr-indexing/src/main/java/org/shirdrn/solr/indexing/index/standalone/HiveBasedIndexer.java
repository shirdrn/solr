...
import org.shirdrn.solr.indexing.index.LineDocCreator;
import org.shirdrn.solr.indexing.index.SingleThreadIndexer;

public class HiveBasedIndexer extends SingleThreadIndexer {

	private static final Log LOG = LogFactory.getLog(HiveBasedIndexer.class);
	// for Hive
	...
	public HiveBasedIndexer(ClientConf clientConf, HiveConf hiveConf) 
	...
	public static class Assembler extends AbstractArgsAssembler<AbstractIndexer> {
		...
		private static final String TYPE_SINGLE_THREAD_HIVE_BASED_INDEXER = "2";
		private static final String NAME_SINGLE_THREAD_HIVE_BASED_INDEXER = "Single_Threaded_Hive_Based_Indexer";

		public Assembler() {
			super();
			argCount = 9;
			type = TYPE_SINGLE_THREAD_HIVE_BASED_INDEXER;
			name = NAME_SINGLE_THREAD_HIVE_BASED_INDEXER;
		}
		...
		public AbstractIndexer assemble(String[] args) throws Exception {
			...
			try {
				indexer = new HiveBasedIndexer(clientConf, hiveConf);
